...
public class AdminPanel extends JPanel {
	...
	public AdminPanel(PanelContainerFrame frame) {
		...
		buttonContainer.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"Aministrative Tools", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 255, 255)));
		add(buttonContainer);
		...
		newPinDialog.addWindowListener(new WindowListener() {
			...
			public void windowClosed(WindowEvent e) {
				...
				if (newPin != null) {
					// confirm
					s[0] = "Confirm Pin";
					s[1] = "Re-enter the same exact pin.";
